                  ...
                  <div className="js-reviews-carousel reviews-carousel text-center text-md-right">
                    <div className="review">
                      ...
                      <p className="review-text">
                        You guys are all amazing! Everyone I have met at your
                        office is kind, thoughtful, and listens to me. Everyone
                        is so friendly from the time you walk in the door to the
                    ...
                    <div className="review">
                      ...
                      <p className="review-text">
                        ...
                        proficient is absolutely adorable. I feel so relaxed in
                        her capable hands and hope to be her patient for a very
                        long time! You are a fantastic team and I feel very
                        privileged to come to you all!!!
                      </p>
                      <p>
                        <span className="review-author">
                          - Wilmer Stevenson,
            ...
            <div className="blog-grid-full blog-grid-carousel-full js-blog-grid-carousel-full mt-3 mb-0 row">
              ...
              <div className="col-md-6 col-lg-4">
                <div className="blog-post bg-grey">
                  ...
                  <div className="post-teaser">
                    No longer is liposuction just used on the abdomen. Patients
                    who come to us from Albany and beyond appreciate the
                    versatility of liposuction — and it can also treat...
                  </div>
                  <div className="mt-2">
                    <a
                      href="blog-post-page.html"
                ...
                <div className="col-sm-6 col-lg-7 d-flex align-items-center justify-content-center">
                  <div className="text-center">
                    <h2>
                      ...
                      <span className="theme-color">
                        Acne, Hair Fall or Skin Issues?
                      </span>
                    </h2>
                    <div className="h-decor" />
                    <p className="mt-sm-1 mt-lg-4 text-left text-sm-center">
                      Don’t ignore your skin problems. Early treatment ensures
